...
class ClientPrefs {
	...
	public static var appText:Bool = true;
	public static var showFPS:Bool = true;
	public static var showMEM:Bool = true;
	public static var fpsAlpha:Float = 0.6;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.fpsAlpha = fpsAlpha;
		//FlxG.save.data.cursing = cursing;
		//FlxG.save.data.violence = violence;
		FlxG.save.data.camZooms = camZooms;
		FlxG.save.data.noteOffset = noteOffset;
		FlxG.save.data.hideHud = hideHud;
		FlxG.save.data.appText = appText;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.appText != null) {
			appText = FlxG.save.data.appText;
		}
