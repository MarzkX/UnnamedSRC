...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		currentSongName = CoolUtil.formatToSongPath(_song.song);
		loadSong();
		reloadGridLayer();
	...
	function addSongUI():Void
	{
		...
		{
			currentSongName = CoolUtil.formatToSongPath(UI_songTitle.text);
			loadSong();
			updateWaveform();
		});
		...
		var loadEventJson:FlxButton = new FlxButton(loadAutosaveBtn.x, loadAutosaveBtn.y + 30, 'Load Events', function()
		{
			...
			var songName:String = CoolUtil.formatToSongPath(_song.song);
	...
	*/
	...
	private function saveLevel()
	{
		...
		if ((data != null) && (data.length > 0))
		{
			...
			_file.save(data.trim(), CoolUtil.formatToSongPath(_song.song) + ".json");
		}
	}
