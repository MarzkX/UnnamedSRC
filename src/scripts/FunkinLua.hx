...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('songPath', CoolUtil.formatToSongPath(PlayState.SONG.song));
		...
		set('difficultyPath', CoolUtil.formatToSongPath(difficultyName));
		...
		Lua_helper.add_callback(lua, "loadSong", function(?name:String = null, ?difficultyNum:Int = -1) {
			...
			var poop = CoolUtil.formatSong(name, difficultyNum);
		...
		Lua_helper.add_callback(lua, "startDialogue", function(dialogueFile:String, music:String = null) {
			var path:String;
			#if MODS_ALLOWED
			path = Paths.modsJson(CoolUtil.formatToSongPath(PlayState.SONG.song) + '/' + dialogueFile);
			if(!FileSystem.exists(path))
			#end
				path = Paths.json(CoolUtil.formatToSongPath(PlayState.SONG.song) + '/' + dialogueFile);
